...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 6.2;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -75.6;
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        searchResults.innerHTML = domputify.sanitize(searchResultsHTML(res.data));
        return;
      }
